...
contract DigicharFactory is Structs { 
  ...
  constructor(address _digicharOwnershipCertificate, address _digicharToken, address _auctionVault, address _targetDex, address _digiswapHook) {
  ...
  uint tokenStartingPrice = 79228162514264337593543950336;
